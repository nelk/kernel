...
\subsection{Output Enhancements}
    ...
    way to a hot-key. Inside the pseudocode algorithm for the
...
void crt_advance_(CRTData *crt) {
    ...
    if (crt->screenBufLen > crt->lineBufLen) {
        // ...
        // Move cursor to bottom, set background to black, foreground to white.
        // ...
    ...
    if (mismatchPos < crt->screenBufLen) {
        // ...
        // Move cursor to the mismatch, set background to black, foreground to white.
        // ...
