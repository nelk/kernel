...
#define receive_message(senderPid) ((Envelope*)(_receiveMessage((uint32_t)bridge_receiveMessage, senderPid)))
uint32_t __SVC_0 _receiveMessage(uint32_t k_func, uint8_t *senderPid);
